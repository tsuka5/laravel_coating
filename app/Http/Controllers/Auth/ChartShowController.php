...
class ChartShowController extends Controller
{
    public function show(string $id, $type)
    {
        ...
        if($type === 'storing_test'){
            ...
            'mass_loss_rates','color_es','phs','moisture_contents','tas','hardnesses','vitamin_cs','rrs', 'days'));
        }
        ...
        elseif($type === 'antibacteria_test'){            
            ...
            // ビューにデータを渡す
            return view('user.profile.antibacteria_test_chart_show', compact('experiment','compositions', 'materials', 'composition_count_list','x_label',
            'colony_days', 'cfu_days', 'survival_rate_days', 'growth_curve_days', 'colony_diameters', 'cfus',
            'survival_rates', 'growth_curves'));
        ...
        elseif($type === 'enzyme_test'){            
            ...
            $days = $days[0];
            // ビューにデータを渡す
            return view('user.profile.enzyme_test_chart_show', compact('experiment','compositions', 'materials', 'composition_count_list','x_label',
            'days', 'enzyme_activities'));
        }
        ...
        elseif($type === 'tga_test'){            
            ...
            // ビューにデータを渡す
            return view('user.profile.tga_test_chart_show', compact('experiment','compositions', 'materials', 'composition_count_list','x_label',
            'temperatures', 'mass_loss_rates'));
        }
    ...
    public function everyone_show(string $id, $type)
    {
        ...
        elseif($type === 'antibacteria_test'){            
            ...
            $growth_curve_days = $growth_curve_days[0];
            // ビューにデータを渡す
            return view('user.search.antibacteria_test_chart_show', compact('experiment','compositions', 'materials', 'composition_count_list','x_label',
            'colony_days', 'cfu_days', 'survival_rate_days', 'growth_curve_days', 'colony_diameters', 'cfus',
            'survival_rates', 'growth_curves'));
        ...
        elseif($type === 'enzyme_test'){            
            ...
            $days = $days[0];
            // ビューにデータを渡す
            return view('user.search.enzyme_test_chart_show', compact('experiment','compositions', 'materials', 'composition_count_list','x_label',
            'days', 'enzyme_activities'));
        }
        ...
        elseif($type === 'tga_test'){            
            ...
            $temperatures = $temperatures[0];
            // ビューにデータを渡す
            return view('user.search.tga_test_chart_show', compact('experiment','compositions', 'materials', 'composition_count_list','x_label',
            'temperatures', 'mass_loss_rates'));
        }
