...
class ProfileController extends Controller
{
    ...
    public function experimentIndex($experiment_id)
    {
        ...
        return view('user.profile.experiment_register', compact(
            'experiment',
            'materials',
            'compositions',
            'storing_test',
            ...
            'gas_list',
            'charactaristic_testCounts',
            'antibacteria_tests_check',
            'eager_experiment_enzyme',
            'eager_composition_enzyme',
            'enzyme_value_check',
    ...
    public function createComposition($experiment_id)
    {
        ...
        return redirect()->route('user.experiment_register', compact('experiment_id'))
            ->with([
                'message' => 'Create Composition Complete',
                'status' => 'info'
            ]);;
    }
    ...
    public function storeExperiment(Request $request)
    {
        $request->validate([
            ...
            'paper_url' => ['string', 'max:255', 'nullable', 'unique:experiments'],
        ]);
