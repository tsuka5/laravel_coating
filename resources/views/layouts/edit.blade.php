                            ...
                            <div class="m-2">
                             ...
                             @if($editType = "material")
                              ...
                              <div class="flex flex-wrap"> 
                                ...
                                <div class="p-2 mx-auto">
                                    <div class="relative">
                                        <label class="leading-7 text-sm text-gray-600">Concentration</label>
                                ...
                                <div class="p-2 mx-auto">
                                    <div class="relative">
                                        <label class="leading-7 text-sm text-gray-600">ph Adjustment (Yes or No)</label>
                                ...
                                <div class="p-2 mx-auto">
                                    <div class="relative">
                                        <label class="leading-7 text-sm text-gray-600">pH purpose</label>
