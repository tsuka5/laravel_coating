                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 mx-auto">
                            ...
                            <div class = "flex justify-center flex-wrap">
                                {{-- 酵素活性のグラフ --}}
                                <canvas id="enzyme_activity" width="400" height="400" class="m-10"></canvas>
                            </div>
...
const day = @json($days);
const enzyme_activity = @json($enzyme_activities);
const enzyme_activity_datasets = [];

composition_count_list.forEach((composition_count, index) => {
    enzyme_activity_datasets.push({
        label: `composition: ${composition_count}`,
        data: enzyme_activity[index],
...
var enzyme_activityChart = createLineChart('enzyme_activity', enzyme_activity_datasets, 'enzyme_activity', day);
