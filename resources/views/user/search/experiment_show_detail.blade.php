                        ...
                        <div class="container px-5 mx-auto">
                          @if($type == 'experiment')
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                ...
                                <div class="p-2 w-full flex justify-around mt-4">
                                  <button type="button" onclick="location.href='{{ route('user.experiment_show') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">Back</button>
                              </div>
                          ...
                          @elseif($type == "material")
                               ...
                               @foreach ($materials as $material)
                                <div class="flex flex-col text-center w-full mb-4 mt-12">
                                    <h4 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Material {{$number_material}} </h4>
                                </div>
                                ...
                                @endforeach
                                <div class="p-2 w-full flex justify-around mt-4">
                                  <button type="button" onclick="location.href='{{ route('user.experiment_show', ['experiment_id' => $experiment_id->experiment_id]) }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">Back</button>
                              </div>
                          ...
                          @elseif($type == 'characteristic_test')
                              @foreach ($characteristic_tests as $charactaristic_test)
                              <div class="flex flex-col text-center w-full mb-4 mt-12">
