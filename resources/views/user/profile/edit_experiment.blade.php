                            ...
                            <div class="flex flex-wrap">
                              ...
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="number" id="storing_temperature" name="storing_temperatur" value="{{ $storing_test->storing_temperature }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                              </div>
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="storing_humidity" class="leading-7 text-sm text-gray-600">Storing humidity (%)</label>
                                    <input type="number" id="storing_humidity" name="storing_humidit" value="{{ $storing_test->storing_humidity }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                              </div>
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
