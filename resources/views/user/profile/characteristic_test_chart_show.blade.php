...
console.log(composition_count_list);
...
var viscosityChart = createBarChart('viscosity', [viscosity_datasets], 'Viscosity', x_label);
...
var contactAngleChart = createBarChart('contact_angle', [contact_angle_datasets], 'contact_angle', x_label);
var shearRateChart = createBarChart('shear_rate', [shear_rate_datasets], 'shear_rate', x_label);
var shearStressChart = createBarChart('shear_stress', [shear_stress_datasets], 'shear_stress', x_label);
var tsChart = createBarChart('ts', [ts_datasets], 'ts', x_label);
var eabChart = createBarChart('eab', [eab_datasets], 'eab', x_label);
var lightTransmittanceChart = createBarChart('light_transmittance', [light_transmittance_datasets], 'light_transmittance', x_label);
var thicknessChart = createBarChart('thickness', [thickness_datasets], 'thickness', x_label);
var moistureContentChart = createBarChart('moisture_content', [moisture_content_datasets], 'moisture_content', x_label);
var d43Chart = createBarChart('d43', [d43_datasets], 'd43', x_label);
var d32Chart = createBarChart('d32', [d32_datasets], 'd32', x_label);
