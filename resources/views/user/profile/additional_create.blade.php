                              ...
                              <div class="flex flex-wrap">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                  <div class="relative">
                                    ...
                                    <input type="number" id="concentration" name="concentration" value="{{ old('concentration') }}" step="0.01" placeholder="ex: 0.80" class="w-full bg-gray-100 bg-opacity-50 rounded border
