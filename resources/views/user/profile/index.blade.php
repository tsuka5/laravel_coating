                                ...
                                @foreach ($experiments as $experiment)
                                    <div class="container border border-gray-500 w-2/5 mb-6 rounded-xl ml-6">
                                        ...
                                        <div class="justify-start">
                                            ...
                                            <div class='flex justify-center mt-2'>
                                                <button onclick="location.href='{{ route('user.create', ['id' => $experiment->id, 'material'])}}'" class="text-white bg-gray-400 border-0 py-2 px-4 focus:outline-none hover:bg-gray-500 rounded">Additive</button>
                                            ...
                                            <div class='flex justify-center mt-2'>
                                                <button onclick="location.href='{{ route('user.create', ['id' => $experiment->id, 'material'])}}'" class="text-white bg-gray-400 border-0 py-2 px-4 focus:outline-none hover:bg-gray-500 rounded">Film_Condition</button>
                                            ...
                                            <div class='flex justify-center mt-2'>
                                                <button onclick="location.href='{{ route('user.create', ['id' => $experiment->id, 'material'])}}'" class="text-white bg-gray-400 border-0 py-2 px-4 focus:outline-none hover:bg-gray-500 rounded">Charactaristic_Test</button>
                                            ...
                                            <div class='flex justify-center mt-2'>
                                                <button onclick="location.href='{{ route('user.create', ['id' => $experiment->id, 'material'])}}'" class="text-white bg-gray-400 border-0 py-2 px-4 focus:outline-none hover:bg-gray-500 rounded">Storing_Test</button>
                                            ...
                                            <div class='flex justify-center mt-2 mb-4'>
                                                <button onclick="location.href='{{ route('user.create', ['id' => $experiment->id, 'material'])}}'" class="text-white bg-gray-400 border-0 py-2 px-4 focus:outline-none hover:bg-gray-500 rounded">Antibacteria_Test</button>
