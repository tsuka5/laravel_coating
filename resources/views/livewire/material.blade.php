                                            ...
                                            <div class="card card-body">
                                                ...
                                                <div class="p-2 w-1/2 mx-auto">
                                                    <div class="relative">
                                                        ...
                                                        <input type="text" name="materials.{{ $key }}.m_name" value="{{ old('m_name') }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                                            id="materials.{{ $key }}.m_name" wire:model.defer="materials.{{ $key }}.m_name">
                                
                                                        @error("materials.$key.m_name")
                                                        <span class="invalid-feedback d-block" role="alert">
                                                                    <strong>{{ $errors->first("materials.$key.m_name") }}</strong>
                                                        </span>
                                                        @enderror
                                                    </div>
                                                </div>
